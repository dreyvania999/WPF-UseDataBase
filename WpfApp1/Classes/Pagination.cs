...
namespace WpfApp1
{
    internal class Pagination : INotifyPropertyChanged  // класс, который наследуется от интерфейса INotifyPropertyChanged
    {
        ...
        public int CountList
        {
            ...
            set
            {
                if (value == 0)
                {
                     MessageBox.Show("Вы слишком малое значение для вывода");
                    return;
                }
                Countlist = value;
